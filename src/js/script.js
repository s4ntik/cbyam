document.addEventListener("DOMContentLoaded", function () {
    ...
    const updateJsonData = function (data) {
        ...
        try {
            ...
            progressBar.style.visibility = parseBoolean(data.gamemode) ? "visible" : "hidden";
            progressBar.style.opacity = parseBoolean(data.gamemode) ? "1" : "0";

            superbowl.style.visibility = parseBoolean(data.gamemode) ? "visible" : "hidden";
            ...
            timer.classList.remove(parseBoolean(data.timer) ? "slide-in" : "slide-out");
